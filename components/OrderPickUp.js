...
import { View, Text, TextInput, TouchableOpacity, Image, Platform, StyleSheet, ActivityIndicator } from 'react-native';
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={{ flex: 1 }}>
        <View style={[styles.container, { paddingTop: insets.top }]}>
          ...
          <Text style={styles.label}>Persona que recibió el producto</Text>
          <TextInput
            value={note}
          ...
          <View style={{
            ...
            <TouchableOpacity
              onPress={handlePay}
              disabled={!file || !client || isSaving}
              style={{
                backgroundColor: !file || !client ? "#ccc" : "#D3423E",
                paddingVertical: 15,
                borderRadius: 25,
                alignItems: "center",
              }}
...
const styles = StyleSheet.create({
  ...
  label: { fontWeight: '600', marginTop: 15, marginBottom: 6, color: '#222' },
  input: { padding: 12, backgroundColor: "#f5f5f5", borderRadius: 10 },
  imageContainer: { borderStyle: 'dashed', borderColor: "#B0B0B0", borderWidth: 1, padding: 15, alignItems: 'center', justifyContent: 'center', height: 120, borderRadius: 8, marginTop: 5 },
  image: { width: 100, height: 100, resizeMode: 'contain' },
  infoBox: { borderWidth: 1, borderColor: "#2E2B2B", borderRadius: 8, padding: 10, marginTop: 10 },
  infoText: { fontSize: 12 },
  textArea: { padding: 12, color: "#2E2B2B", backgroundColor: "#f5f5f5", borderRadius: 10, marginTop: 5, textAlignVertical: 'top' },
  debtAmount: { fontSize: 32, fontWeight: "bold", marginBottom: 20 },
  modalOverlay: { flex: 1, backgroundColor: "rgba(0,0,0,0.4)", justifyContent: "center", alignItems: "center" },
  modalContent: { backgroundColor: "white", padding: 25, borderRadius: 20, alignItems: "center", width: 250 },
  modalText: { fontSize: 18, fontWeight: "bold", color: "#27AE60", marginTop: 10, textAlign: "center" },
});
